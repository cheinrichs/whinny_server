      ...
      return knex('broadcasts').insert({
        ...
        return knex('broadcasts').insert({
          ...
          return knex('broadcasts').insert({
            ...
            broadcast_photo_small: 'https://s3.amazonaws.com/whinnyphotos/broadcast_profile_photos/3_BroadcastProfilePic_small.png',
            geographically_limited: false,
            broadcast_latitude: '40.167207',
            broadcast_longitude: '-105.101927',
            broadcast_zip: 33480,
            ...
            return knex('broadcasts').insert({
              ...
              return knex('broadcasts').insert({
                ...
                broadcast_photo_small: 'https://s3.amazonaws.com/whinnyphotos/broadcast_profile_photos/5_BroadcastProfilePic_small.png',
                geographically_limited: false,
                broadcast_latitude: '40.167207',
                broadcast_longitude: '-105.101927',
                broadcast_zip: 92014,
                ...
                return knex('broadcasts').insert({
                  ...
                  return knex('broadcasts').insert({
                    ...
                    broadcast_photo_small: 'https://s3.amazonaws.com/whinnyphotos/broadcast_profile_photos/7_BroadcastProfilePic_small.png',
                    geographically_limited: false,
                    broadcast_latitude: '40.167207',
                    broadcast_longitude: '-105.101927',
                    broadcast_zip: 92014,
